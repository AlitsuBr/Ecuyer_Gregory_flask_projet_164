...
def film_update_wtf():
    ...
    try:
        ...
        if form_update_film.validate_on_submit():
            ...
            strsql_update_client = "UPDATE t_client SET Prenom = %(prenom)s, Nom = %(nom)s, " \
            ...
            # Opération sur la BD pour récupérer "id_film" et "intituintitule_genrele_genre" de la "t_client"
