...
def demo_select_wtf():
    ...
    # Objet formulaire pour montrer une liste déroulante basé su    r la table "t_client"
    ...
    try:
        ...
        if request.method == "GET":
            ...
            # genre_val_list_dropdown = [(i["id_client"], i["intitule_genre"]) for i in data_genres]
